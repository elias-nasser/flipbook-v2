...
a.prototype = {
    ...
    _isPageLeft: function (t) {
        return !!(t % 2)  // Odd pages are on the left
    },
    _isPageRight: function (t) {
        return !this._isPageLeft(t)  // Even pages are on the right
    },
    ...
    // ARABIC STYLE: Modified for right-to-left page turning
    _setAngle: function (t) {
        t <= -180 ? t = -180 : 180 <= t && (t = 180);
        var o = Math.abs(t), i = (90 < o ? 180 - o : o) / 300;
        
        // For Arabic style: Negative angles = turning right pages forward
        // Positive angles = turning left pages backward
        if (t < 0) {
            // Turning to the right (next page in Arabic book)
            if (null == this.rightBackPage) return;
            
            if (null != this.rightBelowPage && (this.root.pages[this.rightBelowPage].css({ display: "block", transform: "", "z-index": 1 }), this.root._setShowHidePageState(this.rightBelowPage, !0)), 
                ...
                90 < o) {
                // Past 90 degrees - show back page
                ...
                null != this.rightBackPage && (this.root.pages[this.rightBackPage].css({ 
                    ...
                    "z-index": 7 
                }).$shadow.css({ opacity: i }), this.root._setShowHidePageState(this.rightBackPage, !0));
            } else {
                // Before 90 degrees - show current page with fold
                null != this.rightPage && (this.root.pages[this.rightPage].css({ 
                    display: "block", 
                    transform: "rotateY(" + t + "deg) translateZ(0px)", 
                    "z-index": 7 
                }).$shadow.css({ opacity: i }), this.root._setShowHidePageState(this.rightPage, !0));
            ...
            // Adjust book position for right page turn
            if (null == this.leftPage) {
                if (90 < o) {
                    var e = 1 - (o - 90) / 90;
                    var s = s - this.root.pageWidth * this.root._getZoom() / 2 * e;
            ...
            // Turning to the left (previous page in Arabic book)
            if (null == this.leftBackPage) return;
            
            if (null != this.leftBelowPage && (this.root.pages[this.leftBelowPage].css({ display: "block", transform: "", "z-index": 1 }), this.root._setShowHidePageState(this.leftBelowPage, !0)), 
                ...
                null != this.leftBackPage && (this.root.pages[this.leftBackPage].css({ 
                    ...
                    transform: "rotateY(" + (-180 + t) + "deg) translateZ(0px)", 
                    "z-index": 7 
                }).$shadow.css({ opacity: i }), this.root._setShowHidePageState(this.leftBackPage, !0));
            } else {
                // Before 90 degrees - show current page with fold
                null != this.leftPage && (this.root.pages[this.leftPage].css({ 
                    ...
                    transform: "rotateY(" + t + "deg) translateZ(0px)", 
                    "z-index": 7 
                }).$shadow.css({ opacity: i }), this.root._setShowHidePageState(this.leftPage, !0));
            ...
            // Adjust book position for left page turn
            if (null == this.leftBelowPage) {
                if (o < 90) {
                    e = 1 - (90 - o) / 90;
                    s = s - this.root.pageWidth * this.root._getZoom() / 2 * e;
                    this.root.controls.$book.css({ transform: "translateX(" + s + "px)" });
                ...
                e = 1 - (o - 90) / 90;
                s = 0;
                s += this.root.pageWidth * this.root._getZoom() / 2 * e;
                this.root.controls.$book.css({ transform: "translateX(" + s + "px)" });
            }
        }
    },
    ...
    _animateTurnPage: function (t, o) {
        var i = d.Deferred();
        this._stopAnimation();
        var e = this, s = this.root.config.flipDuration / 180 * Math.abs(o - t);
        return this.$animation = d({ angle: t }), this.$animation.animate({ angle: o }, {
            duration: s, easing: "linear", done: function () {
                e.swipe.startAngle = 0;
                var t = e.$animation = null;
                // For Arabic style: -180 = right page turn (next), 180 = left page turn (prev)
                null != (t = -180 == o ? e.rightBackPage : 180 == o ? e.leftBackPage : null != e.rightPage ? e.rightPage : null != e.leftPage ? e.leftPage : null) && e.showPage(t), i.resolve()
            }, fail: function () {
                i.reject()
            }, step: function (t) {
    ...
    updateBook: function (t) {
        for (var o = !0, i = 0, e = this.root.pages.length; i < e; i++) {
            ...
            // ARABIC STYLE: First page is on the right
            s.toggleClass("ipgs-left", o).toggleClass("ipgs-right", !o).removeClass("ipgs-show").addClass("ipgs-hide");
            s.pageLeft = o;
            s.pageRight = !o;
            o = !(s.pageRight = o);
            d(".ipgs-page-data", s)
    ...
    updateBookLayout: function () {
        ...
        for (var o = 0, i = this.root.pages.length; o < i; o++) {
            ...
            // ARABIC STYLE: Right pages on the right side, left pages on the left
            e.css({ left: e.pageRight ? 0 : this.root.pageWidth * this.root._getZoom() - 1 })
        }
    },

    showPage: function (t) {
        t = this._normalizePageIndex(t);
        var o = this._getLeftPageIndex(t), i = this._getRightPageIndex(t), 
            e = this._getBackPageIndex(o), s = this._getBackPageIndex(i), 
            a = this._getBelowPageIndex(o), n = this._getBelowPageIndex(i);
        
        this.root._loadPageData(o), this.root._loadPageData(i);
        this.root.config.preloadNeighbours && (this.root._loadPageData(e), this.root._loadPageData(s), this.root._loadPageData(a), this.root._loadPageData(n));
        
        for (var h = 0, r = this.root.pages.length; h < r; h++) {
            var l = this.root.pages[h], g = "none", p = 0, c = !1;
            if (h == o || h == i) {
                g = "block", p = 1, c = !0;
            }
            // ARABIC STYLE: Right pages on right, left pages on left
            l.css({ 
                display: g, 
                top: 0, 
                left: l.pageRight ? 0 : this.root.pageWidth * this.root._getZoom(), 
                transform: "", 
                "z-index": p 
            });
    ...
    // ARABIC STYLE: Modified gotoPage for right-to-left navigation
    gotoPage: function (t) {
        if (this._stopAnimation(!0), t = this._normalizePageIndex(t), this.leftPage != t && this.rightPage != t) {
            var o = t;
            // ARABIC STYLE: If target page number is greater, turn right (next)
            // If target page number is smaller, turn left (prev)
            var i = o > this.root.currPage ? -180 : 180;
            
            if (i < 0) {
                // Turning right (next page in Arabic book)
                ...
                if (this._isPageLeft(o)) {
                    this.rightBackPage = o;
                    this.rightBelowPage = this._getRightPageIndex(o);
                } else {
                    this.rightBackPage = this._getLeftPageIndex(o);
                    this.rightBelowPage = o;
                }
            } else {
                // Turning left (previous page in Arabic book)
                ...
                if (this._isPageRight(o)) {
                    this.leftBackPage = o;
                    this.leftBelowPage = this._getLeftPageIndex(o);
                } else {
                    this.leftBackPage = this._getRightPageIndex(o);
                    this.leftBelowPage = o;
                }
            }
    ...
    // ARABIC STYLE: Next page = turn right (negative angle)
    gotoNext: function () {
        null != this.rightBackPage && this.gotoPage(this.rightBackPage)
    },

    // ARABIC STYLE: Previous page = turn left (positive angle)
    gotoPrev: function () {
        null != this.leftBackPage && this.gotoPage(this.leftBackPage)
    },

    // ARABIC STYLE: Swipe handlers reversed for natural Arabic direction
    ...
    onSwipeMove: function (t) {
        if (this.swipe.startTouch) {
            ...
            this.swipe.prevAngle = this.swipe.angle;
            // ARABIC STYLE: Reverse direction - swiping left (negative diffX) turns to next page
    ...
    onSwipeUp: function (t) {
        if (this.swipe.startTouch) {
            ...
            // ARABIC STYLE: Thresholds for page turns
            // Swipe left enough (negative) = next page (-180)
            // Swipe right enough (positive) = prev page (180)
            var i = Math.abs(this.swipe.angle) < this.swipe.angleThreshold ? 0 : this.swipe.angle < 0 ? -180 : 180;
            
            if ((i < 0 && 0 < this.swipe.angle - this.swipe.prevAngle || 0 < i && this.swipe.angle - this.swipe.prevAngle < 0) && (i = 0);
            if (i == o || 0 < i && null == this.leftPage || i < 0 && null == this.rightPage) {
                this._clearSwipe();
                return;
            }
...
// OnePageFlip engine (unchanged but may need similar modifications for Arabic)
n.prototype = {
    _normalizePageIndex: function (t) {
        return t ? t < 0 ? 0 : t > this.root.pages.length - 1 ? this.root.pages.length - 1 : t : 0
    },
    ...
    _setAngle: function (t) {
        ...
        if (t < 0) {
            ...
            null != this.prevPage && (this.root.pages[this.prevPage].css({ display: "none" }), this.root._setShowHidePageState(this.prevPage, !1)), null != this.currPage && (this.root.pages[this.currPage].css({ display: "block", transform: "rotateY(" + t + "deg) translateZ(0px)", "z-index": 2 }).$shadow.css({ opacity: 0 }), this.root._setShowHidePageState(this.currPage, !0)), null != this.nextPage && (this.root.pages[this.nextPage].css({ display: "block", transform: "", "z-index": 1 }), this.root._setShowHidePageState(this.nextPage, !0))
        } else if (0 <= t) {
            if (null == this.prevPage) return;
            null != this.prevPage && (this.root.pages[this.prevPage].css({ display: "block", transform: "rotateY(" + (-90 + t) + "deg) translateZ(0px)", "z-index": 2 }).$shadow.css({ opacity: 0 }), this.root._setShowHidePageState(this.prevPage, !0)), null != this.currPage && (this.root.pages[this.currPage].css({ display: "block", transform: "", "z-index": 1 }), this.root._setShowHidePageState(this.currPage, !0)), null != this.nextPage && (this.root.pages[this.nextPage].css({ display: "none" }), this.root._setShowHidePageState(this.nextPage, !1))
        }
    },
    _animateTurnPage: function (t, o) {
        var i = d.Deferred();
        this._stopAnimation();
        var e = this, s = this.root.config.flipDuration / 90 * Math.abs(o - t);
        return this.$animation = d({ angle: t }), this.$animation.animate({ angle: o }, {
            duration: s, easing: "linear", done: function () {
                e.swipe.startAngle = 0;
                var t = e.$animation = null;
    ...
    updateBookLayout: function () {},
    showPage: function (t) {
        var o = t = this._normalizePageIndex(t), i = this._getPrevPageIndex(o), e = this._getNextPageIndex(o);
        ...
        this.root.currPage = t, this.currPage = o, this.prevPage = i, this.nextPage = e, null != this.currPage && this.root.pages[this.currPage].$shadow.css({ opacity: 0 }), null != this.prevPage && this.root.pages[this.prevPage].$shadow.css({ opacity: 0 }), null != this.nextPage && this.root.pages[this.nextPage].$shadow.css({ opacity: 0 }), this.updateBookLayout(), this.root._onShowPage(t)
    },
    gotoPage: function (t) {
        if (this._stopAnimation(!0), t = this._normalizePageIndex(t), this.currPage != t) {
            var o = t, i = o < this.currPage ? 90 : -90;
            i < 0 ? (null != this.prevPage && this.root.pages[this.prevPage].css({ display: "none", transform: "", "z-index": 0 }), this.nextPage = o) : (null != this.nextPage && this.root.pages[this.nextPage].css({ display: "none", transform: "", "z-index": 0 }), this.prevPage = o), this._animateTurnPage(0, i)
        }
    },
    gotoNext: function () {
    ...
    onSwipeUp: function (t) {
        if (this.swipe.startTouch) {
            this.swipe.startTouch = !1;
            var o = this.swipe.angle, i = Math.abs(this.swipe.angle) < this.swipe.angleThreshold ? 0 : this.swipe.angle < 0 ? -90 : 90;
...
h.prototype = {
    ...
    _animateSwipePage: function (t, o) {
        ...
        this._stopAnimation();
        var e = this, s = this.root.config.flipDuration / 90 * Math.abs(o - t);
        return this.$animation = d({ offset: t }), this.$animation.animate({ offset: o }, {
            duration: s, easing: "linear", done: function () {
    ...
    gotoPage: function (t) {
        if (this._stopAnimation(!0), t = this._normalizePageIndex(t), this.currPage != t) {
            var o = t, i = o < this.currPage ? 50 : -50;
            i < 0 ? (null != this.prevPage && this.root.pages[this.prevPage].css({ display: "none", transform: "", "z-index": 0 }), this.nextPage = o) : (null != this.nextPage && this.root.pages[this.nextPage].css({ display: "none", transform: "", "z-index": 0 }), this.prevPage = o), this._animateSwipePage(0, i)
        }
    },
    gotoNext: function () {
        null != this.nextPage && this.gotoPage(this.nextPage)
    ...
    onSwipeUp: function (t) {
        if (this.swipe.startTouch) {
            this.swipe.startTouch = !1;
            var o = (this.root.controls.$bookWrap.width() / 2 + this.root.pageWidth / 2) * this.swipe.offset / 50, i = this.swipe.offset, e = Math.abs(o) < this.swipe.offsetThreshold ? 0 : this.swipe.offset < 0 ? -50 : 50;
...
// Main plugin definition (unchanged)
b.prototype = {
    VERSION: "1.3.4",
    defaults: {
    ...
    _create: function () {
        ...
        function e() {
            ...
            i.controls.$book.css({ width: i.bookWidth, height: i.bookHeight }), i._initPages(), i._initThumbnails(), i._initBookmarks(), i._setZoom({ zoom: i.config.zoom }, !0, !0), i._updateSize(), i._updateBookEngine(), i._ready()
        }
    ...
    _ready: function () {
        ...
        this.controls.$book.addClass("ipgs-no-transition"), this.$container.addClass("ipgs-ready"), this.ready = !0, this.$container.trigger("elias:ready", [this]);
        var o = this;
        setTimeout(function () {
    ...
    _buildToolbarDOM: function () {
        if (this.config.toolbar) {
            ...
            for (var t = [], o = [], i = 0; i < this.config.toolbarControls.length; i++) {
                var e = this.config.toolbarControls[i], s = d("<i></i>").addClass(e.icon), a = d("<div></div>").addClass("ipgs-control").addClass("ipgs-control-" + e.type).addClass(e.active ? "" : "ipgs-hidden").attr("title", e.title).append(s);
                switch (a.on("click", d.proxy(this._onToolbarControlClick, this)), e.type) {
                    ...
                    case "share":
                        ...
                        for (var n = 0; n < this.config.shareControls.length; n++) {
                            ...
                            if (h.active) {
                                var r = d("<i></i>").addClass(h.icon), l = d("<div></div>").addClass("ipgs-share-control-" + e.type).attr("title", h.title).append(r);
    ...
    _initThumbnails: function () {
        if (this.controls.$thumbnails) for (var t = this.pageHeight / this.pageWidth, o = .8 * this.controls.$thumbnails.outerWidth(), i = t * o, e = 0; e < this.pages.length; e++) {
            var s = this.pages[e], a = d("<div></div>").addClass("ipgs-preloader"), n = d("<div></div>").addClass("ipgs-number").text(e + 1), h = d("<div></div>").css({ width: o + "px", height: i + "px" }).addClass("ipgs-thumb").addClass("ipgs-loading").attr("data-page-index", e).appendTo(this.controls.$thumbnails).append(a, n);
    ...
    _addBookmarks: function (t, o) {
        if (o && 0 < o.length) {
            ...
            for (var e = 0; e < o.length; e++) {
                var s = o[e], a = d("<div></div>").addClass("ipgs-state"), n = d("<div></div>").addClass("ipgs-link").html(s.text), h = d("<div></div>").addClass("ipgs-bookmark"), r = s.target ? s.target : "page", l = 0 != s.folded;
    ...
    _initPages: function () {
        ...
        if (t.remove(), this.config.pdfAutoCreatePages && this.pdf) for (i = 0; i < this.pdf.numPages; i++) {
            var s = d("<div></div>").addClass("ipgs-no-come-back").attr("data-ipgs-pdf-page", i + 1);
            this._addPage(s)
        }
        if (this.config.pageImagesUrl) for (i = 0; i < this.config.pageImagesCount; i++) {
    ...
    _updateBook: function (t) {
        for (var o = 0, i = this.pages.length; o < i; o++) {
            ...
            if (e.pageIndex = o, e.pageNumber = this.config.pageNumbersFirst + o, this.config.pageNumbers) {
                var s = o + 1, a = o - this.pages.length;
    ...
    _updateSize: function () {
        var t = this._getZoom(), o = this.bookWidth, i = this.bookHeight, e = this.stagePadding.top, s = this.stagePadding.bottom, a = this.stagePadding.left, n = this.stagePadding.right, h = this.controls.$stage.outerWidth() - a - n;
        if (this.config.autoHeight) {
            var r = (d = i / o) * (!this.config.autoFit && o < h ? o : h) + e + s;
            this.$container.css({ height: r })
        }
        var l, g, p, c, u = this.controls.$stage.outerHeight() - e - s, d = 1;
        (u = u <= 0 ? i : u, this.config.responsive && !this.config.autoFit) && ((h < o || u < i) && (d = (c = u / i) < (p = h / o) ? c : p));
        this.config.autoFit && (d = (c = u / i) < (p = h / o) ? c : p);
        l = (u - i * d) / 2, g = (h - o * d) / 2, this.controls.$bookTransform.css({ top: l + e + "px", left: g + a + "px" }), this.controls.$bookWrap.css({ width: o * d + "px", height: i * d + "px" }), this.controls.$bookWrap.get(0).offsetHeight, this.controls.$bookSize.css({ transform: "scale(" + 1 / t * d + ")" }), this._updateThumbnails(), this.engine.updateBookLayout()
    },
    
    _updateBookEngine: function () {
        var t = this.config.bookEngineLandscape || this.config.bookEngine, o = this.config.bookEnginePortrait || this.config.bookEngine, i = this.stagePadding.top, e = this.stagePadding.bottom, s = this.stagePadding.left, a = this.stagePadding.right;
    ...
    _updateZoomPosition: function () {
        ...
        this.controls.$bookTransform.css({ transform: "translate3d(" + o.x + "px," + o.y + "px, 0) scale(" + t + ")" }), this.controls.$book.addClass("ipgs-no-transition"), this.controls.$book.css({ width: this.bookWidth * t + "px", height: this.bookHeight * t + "px" });
    ...
    _setDeltaPosition: function (t) {
        var o = t.dx || 0, i = t.dy || 0, e = this.matrix.inverse().transformPoint(o, i), s = this.matrix.inverse().transformPoint(0, 0), a = e[0] - s[0], n = e[1] - s[1];
    ...
    _setZoom: function (t, o, i) {
        ...
        if (null != this.config.zoomMin && (e = Math.max(this.config.zoomMin, e)), null != this.config.zoomMax && (e = Math.min(this.config.zoomMax, e)), i || e != this._getZoom()) {
            var s = this.matrix.m[4], a = this.matrix.m[5];
            this.matrix.reset().translate(s, a).scale(e, e), o && this._updateZoomPosition()
        }
    },
    
    _setDeltaZoom: function (t) {
        var o = t.zoom || 1, i = t.focalPoint || { x: this.matrix.m[4], y: this.matrix.m[5] };
        ...
        var s = this.matrix.inverse().transformPoint(i.x, i.y), a = s[0], n = s[1];
    ...
    _setBackgroundImage: function (t, o) {
        t.$image ? (t.css({ "background-image": t.$image.css("background-image") }), t.$image.css({ "background-image": o ? "url(" + o + ")" : "none" })) : t.css({ "background-image": o ? "url(" + o + ")" : "none" }), t.pageLoading = !1, t.pageLoaded = !0, t.toggleClass("ipgs-loading", !t.pageLoaded)
    },
            ...
            if (a.pdfPage && a.zoom != this._getZoom() && (a.zoom = this._getZoom(), a.pageLoaded = !1, a.pageLoading = !1), !a.pageLoaded && !a.pageLoading) {
                ...
                if (a.image) {
                    ...
                    n.pdf.getPage(a.pdfPage).then(function (t) {
                        var o = t.getViewport(n.pageWidth * n._getZoom() / t.getViewport(1).width), i = d("<canvas>"), e = i.get(0).getContext("2d");
    ...
    _loadThumbData: function (a) {
        if (!a.pageLoaded && !a.pageLoading) {
            ...
            if (a.image) {
                ...
                var o = t.getViewport(a.width() / t.getViewport(1).width), i = d("<canvas>"), e = i.get(0).getContext("2d");
    ...
    _setShowHidePageState: function (t, o) {
        var i = this.pages[t];
        o ? i.hasClass("ipgs-hide") && (i.removeClass("ipgs-hide"), i.get(0).offsetHeight, i.addClass("ipgs-show"), i.removeClass(i.hideCSSClass).addClass(i.showCSSClass), this._loadPageData(t), this.$container.trigger("elias:showpage", [this, t])) : i.hasClass("ipgs-show") && (i.removeClass("ipgs-show"), i.get(0).offsetHeight, i.addClass("ipgs-hide"), i.removeClass(i.showCSSClass).addClass(i.hideCSSClass), this.$container.trigger("elias:hidepage", [this, t])), this.config.prevnextButtons && 0 < this.pages.length && (this.controls.$prevBtn.toggleClass("ipgs-active", !this.pages[0].hasClass("ipgs-show")), this.controls.$nextBtn.toggleClass("ipgs-active", !this.pages[this.pages.length - 1].hasClass("ipgs-show")))
    },
    ...
    _onShowPage: function (t) {
        ...
        if (this.config.toolbar) if ("ipgs-twopageflip" == this.engineClass) {
            var i, e = 0;
    ...
    _onMouseWheelZoom: function (t, o) {
        ...
        var i, e = this.controls.$stage.get(0).getBoundingClientRect(), s = t.clientX, a = t.clientY, n = 1 + .1 * o;
    ...
    _onThumbnailsRefresh: function () {
        if (this.controls.$thumbnails.hasClass("ipgs-active") && 0 != this.pages.length) for (var t = this.controls.$thumbnails.find(".ipgs-thumb:first-child").outerHeight(!0), o = this.controls.$thumbnails.outerHeight(), i = this.controls.$thumbnails.scrollTop(), e = i + o, s = Math.floor(i / t), a = Math.floor(e / t), n = s; n <= a && n < this.pages.length; n++) this._loadThumbData(this.pages[n].$thumb)
    },
    ...
    _onBookmarkClick: function (t) {
        ...
        if (d(t.target).is(".ipgs-state")) o.toggleClass("ipgs-folded");
            ...
            var i = o.data("link"), e = o.data("target");
            if (i) if ("page" == e) {
                var s = parseInt(i, 10);
                if (isNaN(s)) return;
    ...
    _onDownload: function (t) {
        if (this.config.pdfUrl) {
            var o = this.config.pdfUrl.substring(this.config.pdfUrl.lastIndexOf("/") + 1, this.config.pdfUrl.length), i = d("<a></a>").attr("href", this.config.pdfUrl).attr("download", o);
    ...
    _destroy: function () {
        var t = this.$container, o = this.$container.find(".ipgs-come-back");
    ...
    setBookEngine: function (t) {
        ...
        this.controls.$book.css({ width: this.bookWidth }), 0 < this.pages.length && this._updateBook(1), this._updateSize(), this.controls.$bookTransform.removeClass("ipgs-no-transition"), this.controls.$book.removeClass("ipgs-no-transition")
    }
};

// jQuery plugin definition
d.fn.elias = function (i, t) {
    if ("instance" == i) {
        var o = d(this).data(v);
        return o || void console.error('Calling "instance" method on not initialized instance is forbidden')
    }
    return this.each(function () {
        var n = d(this), h = n.data(v), t = n.data("json"), r = n.data("pdf-src"), l = n.data("pdf-disable-range-requests"), g = n.data("book-engine"), p = parseInt(n.data("page-width"), 10), c = parseInt(n.data("page-height"), 10), u = d.isPlainObject(i) ? i : t ? null : {};
        ...
        function o() {
            ...
            function o(t, o) {
                for (var i = [], e = 0; e < o.length; e++) for (var s = o[e], a = 0; a < t.length; a++) {
            ...
            if (t.bookEngine = g || t.bookEngine, t.pageWidth = isNaN(p) ? t.pageWidth : p, t.pageHeight = isNaN(c) ? t.pageHeight : c, "boolean" == typeof l && (t.pdfDisableRangeRequests = l), null == t.pdfUrl && r && (t.pdfUrl = r, t.pdfAutoCreatePages = !0, t.pdfBookSizeFromDocument = !0), u.toolbarControls && u.toolbarControls instanceof Array && (t.toolbarControls = o(b.prototype.defaults.toolbarControls, u.toolbarControls)), u.shareControls && u.shareControls instanceof Array && (t.shareControls = o(b.prototype.defaults.shareControls, u.shareControls)), u.bookmarks && u.bookmarks instanceof Array && (t.bookmarks = d.extend(!0, [], u.bookmarks)), null == t.flipSoundUrl) {
                var i = f.getElementsByTagName("script"), e = "jquery.elias.min", s = null;
                if (i && 0 < i.length) for (var a in i) if (i[a].src && i[a].src.match(new RegExp(e + "\\.js$"))) {
        ...
        h && (n.removeData(v), h._destroy(), h = null), null == u ? d.ajax({ url: t, type: "GET", dataType: "json" }).done(function (t) {
